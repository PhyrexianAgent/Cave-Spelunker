...
public class Hook : MonoBehaviour {
	...
	public SpringJoint2D PlayerSpringJoint; //the SpringJoint attached to the player object
	...
	void Update()
	{
		...
		MousePosition.z = 0; //you can change this depending on your game. test it out on "15" first, it may be some sort of default value
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if(other.gameObject.name == "Cave Floors")
		{
			...
			PlayerSpringJoint.distance = 2; //setting the maxDistance for SpringJoint that the player has to 2
